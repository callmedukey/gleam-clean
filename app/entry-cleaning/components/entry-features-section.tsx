...
const featuresData: FeatureCard[] = [
  ...
  },
  {
    ...
    description:
      "청소는 '얼마나 잘하느냐'그뿐만 아니라 '얼마나 잘 들어주느냐'도 중요합니다. 저희는 청소 전 사전 상담을 통해 고객님의 요청사항, 민감 구역, 우선순위 등을 충분히 듣고 반영합니다. 작업 중간에도 실시간 피드백을 주고받을 수 있도록 직접 소통하며, 청소 후 불편 사항이 있을 경우 사후 처리(AS)까지 책임지고 도와드립니다.",
  ...
  },
  {
    ...
    description:
      "청소만으로 부족할 수 있는 냄새 제거 및 유해균 차단까지 고려했습니다. 모든 입주청소 고객에게 천연 피톤치드 성분을 활용한 방역 소독을 추가 비용 없이 무료로 제공해 드립니다.",
