...
const ACFeaturesSection = () => {
  const features: FeatureCard[] = [
    ...
    },
    {
      ...
      description:
        "에어컨의 바람은 우리의 호흡기로 들어오기 때문에, 인체에 해로운 세제는 절대 사용하지 않습니다. 글림케어는 오직 인체에 무해한 친환경 성분의 세제를 고수하며, 환경까지 고려한 안전한 클리닝을 제공합니다.",
      image: ecoFriendlyCleaningImg,
      imagePosition: "left",
      points: [
        { number: "01", text: "인체에 무해한 강력한 세정력" },
        { number: "02", text: "온 가족을 위한 안전한 선택" },
      ],
    },
    {
      title: "고압세척으로 깊은 미세 공간까지 해결",
      ...
      points: [
        ...
        { number: "02", text: "미세 공간부터 숨겨진 오염까지 완벽하게 해결" },
        {
          number: "03",
