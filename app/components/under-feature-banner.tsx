import { UnderFeatureBannerContent } from "./under-feature-banner-content";
...
function UnderFeatureBanner() {
  return (
    <section className="bg-white w-full py-20 px-4">
      ...
      {/* New implementation from Figma */}
      <div className="max-w-[73.125rem] mx-auto flex flex-col gap-14">
        <UnderFeatureBannerContent />
      </div>
    </section>
  );
}
